...
namespace ScratchCardAsset.Core
{
	...
	public class ScratchCardRenderer
	{
		...
		private List<Vector3> positions = new List<Vector3>(1000);
		private List<Color> colors = new List<Color>(1000);
		private List<int> indices = new List<int>(1000);
		private List<Vector2> uv = new List<Vector2>(1000);
