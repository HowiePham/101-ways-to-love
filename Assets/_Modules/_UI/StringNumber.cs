...
namespace FrogunnerGames
{
    public static class StringNumber
    {
        ...
        static StringNumber()
        {
            NumberString1Digit = new string[200000];
        ...
        public static string SecondToDigitalClockText(this float time)
        {
            var minutes = Mathf.FloorToInt(time / 60);
            var seconds = Mathf.FloorToInt(time % 60);

            return $"{NumberString2Digit[minutes]}:{NumberString2Digit[seconds]}";
        }
    }
}