...
command = f'{unityPath} -quit -batchmode -disable-assembly-updater -projectPath "{ProjectFolder}" -buildTarget {BuildTarget} -logFile {Logfile} -executeMethod {UnityBuildMethodName}'
