...
namespace _Modules._UI.WinView.Scripts
{
    public class WinView : BaseView
    {
        ...
        public override void Initialize()
        {
            ...
            if (this.chapterRewardView != null)
                this.chapterRewardView.Initialize(
                    onBonusClicked: () => OnBonusClicked?.Invoke(),
                    onLoseBonusClicked: () => OnLoseBonusClicked?.Invoke());
        ...
        {
            this.chapterRewardView?.SetData(show, currentLife);
        }
        ...
        {
            if (this.chapterRewardView != null)
                await this.chapterRewardView.PlayBonusRewardAndCloseAsync(ct, ShowNormalButtonsEffect);
        }
        ...
        {
            this.chapterRewardView?.SetBonusButtonsInteractable(value);
        }
    }
}
