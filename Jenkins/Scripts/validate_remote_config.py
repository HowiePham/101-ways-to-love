...
if __name__ == "__main__":
    try:
        ...
        version = build_config.read(build_config.KEY.APP_VERSION)
        ...
        if not result:
            build_config.write(build_config.KEY.BUILD_ERROR_MESSAGE, f"Remote Config validation failed! Missing config for new version: {version}")
            sys.exit(1)
